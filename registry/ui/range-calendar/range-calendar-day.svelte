...
<RangeCalendarPrimitive.Day
	...
	class={cn(
		...
		"flex size-(--cell-size) flex-col rounded-(--cell-radius) items-center justify-center gap-1 p-0 leading-none font-normal whitespace-nowrap select-none",
		...
		"dark:data-[range-middle]:hover:bg-accent/50 dark:data-[range-middle]:text-accent-foreground",
		// hover
