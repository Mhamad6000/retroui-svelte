<script lang="ts" module>
	...
	export const calendarVariants = tv({
		...
		variants: {
			variant: {
				default: "border-2 border-border shadow-md",
				outline: "border-2 border-border bg-transparent",
				primary: "border-2 border-primary bg-primary/5",
			},
		},
		defaultVariants: {
			variant: "default",
	...
	export type RangeCalendarVariant = VariantProps<typeof calendarVariants>["variant"];
</script>
...
<script lang="ts">
	...
	import type { ButtonVariant } from "$registry/ui/button/index.js";
