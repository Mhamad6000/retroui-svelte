<script lang="ts">
	...
	import * as Chart from "$registry/ui/chart/index.js";
...
<Card.Root class="w-full gap-5 py-5">
	<Card.Header>
		<Card.Title class="mb-0">Move Goal</Card.Title>
	...
	<Card.Content class="flex flex-1 flex-col p-0">
		<div class="flex items-center justify-center gap-4">
			<Button
				variant="outline"
				size="icon"
				class="size-7 rounded-full shadow-sm"
				onclick={() => onClick(-10)}
				disabled={goal <= 200}
			>
				<MinusIcon />
