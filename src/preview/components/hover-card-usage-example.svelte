<script lang="ts">
	...
	import * as HoverCard from "$registry/ui/hover-card/index.js";
</script>
...
<HoverCard.Root>
	<HoverCard.Trigger
		...
		class="rounded-sm underline-offset-4 hover:underline focus-visible:outline-2 focus-visible:outline-offset-8 focus-visible:outline-border"
	>
		@sveltejs
	</HoverCard.Trigger>
